...
The criteria defined in Table \ref{table:Criteria}, developed by health professionals, will be used to define the structure and content that a health-related article must have to be considered as a credible source of information. 
