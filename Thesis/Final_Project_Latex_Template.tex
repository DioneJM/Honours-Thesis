...
Performance of the QRNN-based models was lower than what was initially expected, however this can be theorised to be due to the relatively low number of training samples used for training the fine-tuned LM. When compared to the work conducted by Howard et al. \cite{Howard2018}, the number of training samples used to construct the discriminative fine-tuned LM for question classification was 5,500 which only improved the model's performance by 0.3\%

\textit{Note \#1 for Adam: Im thinking of investigating the relationship between the resulting f1-scores for a criteria and the label imbalance of that criteria (See the average f1 scores for Criteria 3, the most imbalanced label also has the highest f1 scores). Do you think this is worthwhile?}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{2.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{2.5cm}|}
		...
		\textbf{Model} & \textbf{Criteria 1    }                                                                       & \textbf{Criteria 2}    & \textbf{Criteria 3 }& \textbf{Criteria 4} & \textbf{Criteria 5} & \textbf{Criteria 6} & \textbf{Criteria 7         } & \textbf{Average \newline Performance}                                                                                                                                                                                                                                                                                                                                          \\
		\hline

		NB + BoW (all words)  & 0.79  & 0.70  & 0.86  & \textbf{0.84}  & 0.79   & \textbf{0.75 }  & \textbf{0.82} & 0.792  \\
		\hline
		
		NB + BoW (stopwords \newline removed) & \textbf{0.85} &  0.79 &  \textbf{0.90}  &  \textbf{0.84} &   \textbf{0.80}   &  0.74   &  0.80 & \textbf{0.820}    \\
		\hline
		
		NB + \newline TF-IDF \newline (all words)   & 0.79 & 0.74 & 0.87 & 0.80 & 0.79  & 0.62  & 0.80 & 0.773 \\
		\hline
		
		NB + \newline TF-IDF \newline (stopwords \newline removed)  &  0.79 & \textbf{0.80}  &  0.89 &  0.81 & 0.77   & 0.69   &  0.81 & 0.794  \\
		\hline
		
		NB + GloVe  & 0.82 & 0.78 & 0.89 & 0.82  & 0.78   & 0.68    & 0.83 & 0.800   \\
		\hline                                                                                                                                                     
	\end{tabular}}
	\caption{Micro averaged f1-Scores of the NB models}
	\label{table:PerformanceResultsNB}
\end{table}

\begin{table}[H]
	\centering
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{2.6cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
			
			
			\hline
			
			\textbf{Model} & \textbf{NB + BoW (all words)    }                                                                       & \textbf{NB + BoW (stopwords \newline removed)}    & \textbf{NB + \newline TF-IDF \newline (all words) }& \textbf{NB + \newline TF-IDF \newline (stopwords \newline removed)} & \textbf{NB + GloVe}                                                                                                                                                                                                                                                                                                                                    \\
			\hline
			
			\textbf{Criteria 1}  & 0.79 & 0.85 & 0.79 & 0.79 & 0.82 \\ 
			\hline
			
			\textbf{Criteria 2} & 0.70 & 0.79 & 0.74 & 0.80 & 0.78 \\ 
			\hline
			
			\textbf{Criteria 3 } & 0.86 & 0.90 & 0.87 & 0.89 & 0.89 \\ 
			\hline
			
			\textbf{Criteria 4}  & 0.84 & 0.84 & 0.80 & 0.81 & 0.82 \\ 
			\hline
			
			\textbf{Criteria 5}  & 0.79 & 0.80 & 0.79 & 0.77 & 0.78 \\ 
			\hline 
			
			\textbf{Criteria 6} & 0.75 & 0.74 & 0.62 & 0.69 & 0.68 \\ 
			\hline      
			
			\textbf{Criteria 7} & 0.82 & 0.80 & 0.80 & 0.81 & 0.83 \\ 
			\hline     
			
			\textbf{Average \newline Performance } & 0.792 & \textbf{0.820} & 0.773 & 0.794 & 0.800      \\
			\hline                                                                                                                                          
	\end{tabular}}
	\caption{Micro averaged f1-Scores of the NB models}
	\label{table:PerformanceResultsNB}
...
\begin{table}[H]
	...
	\end{tabular}}
	\caption{Micro averaged f1-Scores of the SVM models}
	\label{table:PerformanceResultsSVM}
\end{table}

\begin{table}[H]
	\centering
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{2.7cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
			
			
			\hline
			
			\textbf{Model} & \textbf{SVM + BoW (all words)    }                                                                       & \textbf{SVM + BoW (stopwords \newline removed)}    & \textbf{SVM + \newline TF-IDF \newline (all words) }& \textbf{SVM + \newline TF-IDF \newline (stopwords \newline removed)} & \textbf{SVM + GloVe}                                                                                                                                                                                                                                                                                                                                    \\
			\hline
			
			\textbf{Criteria 1}  & 0.82 & 0.78 & 0.80 & \textbf{0.86} & 0.60 \\ 
			\hline
			
			\textbf{Criteria 2} & 0.70 & 0.80 & 0.70 & \textbf{0.85} & 0.77 \\ 
			\hline
			
			\textbf{Criteria 3 } & 0.86 & \textbf{0.90} & 0.84 & 0.89 & 0.63 \\ 
			\hline
			
			\textbf{Criteria 4}  & 0.80 & \textbf{0.87} & 0.84 & 0.86 & 0.61 \\ 
			\hline
			
			\textbf{Criteria 5}  & 0.68 & 0.78 & \textbf{0.80} & \textbf{0.80} & 0.59 \\ 
			\hline 
			
			\textbf{Criteria 6} & 0.75 & 0.72 & 0.68 & \textbf{0.77} & 0.67 \\ 
			\hline      
			
			\textbf{Criteria 7} & \textbf{0.86} & 0.81 & 0.82 & 0.82 & 0.81 \\ 
			\hline         
			
			\textbf{Average \newline Performance } & 0.799 & 0.809 & 0.783 & \textbf{0.836} & 0.669      \\
			\hline                                                                                                                                 
	\end{tabular}}
	\caption{Micro averaged f1-Scores of the SVM models}
	\label{table:PerformanceResultsSVM}
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{2.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{2.5cm}|}
			...
			QRNN + \newline Fine-tuned LM  & \textbf{0.42} & \textbf{0.39} & \textbf{0.44} & \textbf{0.40} & \textbf{0.41} & \textbf{0.41}  & \textbf{0.43} & \textbf{0.414 }  \\
			\hline
			
	\end{tabular}}
	\caption{Micro averaged f1-Scores of the QRNN models}
...
\begin{table}[H]
	\centering
		...
		\begin{tabular}{|p{2.6cm}|p{3cm}|p{3cm}|}
			
			
			\hline
			
			\textbf{Model} & \textbf{QRNN + \newline General LM    }                                                                       & \textbf{QRNN + \newline Fine-tuned LM }                                                                                                                                                                                                                                                                                                                             \\
			\hline
			
			\textbf{Criteria 1}  & 0.38 & \textbf{0.42}  \\ 
			\hline
			
			\textbf{Criteria 2} & 0.36 & \textbf{0.39 } \\ 
			\hline
			
			\textbf{Criteria 3 } & 0.41 & \textbf{0.44}  \\ 
			\hline
			
			\textbf{Criteria 4}  & 0.37 & \textbf{0.40} \\ 
			\hline
			
			\textbf{Criteria 5}  & 0.36 & \textbf{0.41} \\ 
			\hline 
			
			\textbf{Criteria 6} & 0.38 & \textbf{0.41}  \\ 
			\hline      
			
			\textbf{Criteria 7} & 0.39 & \textbf{0.43} \\ 
			\hline     
			
			\textbf{Average \newline Performance } & 0.379 & \textbf{0.414} \\
			\hline                                                                                                                                          
	\end{tabular}
	\caption{Micro averaged f1-Scores of the QRNN models}
	\label{table:PerformanceResultsQRNN}
...
\begin{figure}[H]
	\centering
	\includegraphics[totalheight=8cm]{images/single-model-performance.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[totalheight=8cm]{images/ensemble-performance.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[totalheight=8cm]{images/binary-performance.png}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Average training time of models using statistical LMs.}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Aggregated size of NB models.}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Aggregated size of SVM models.}
	\label{table:NBStorageRequirements}
\end{table}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Aggregated size of QRNN models.}
	\label{table:NBStorageRequirements}
\end{table}
