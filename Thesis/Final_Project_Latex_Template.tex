...
\begin{enumerate}
	\item Preprocessing had to be general, as each feature required a specific kind transformation
	\item Created 3 datasets: list of articles, list of sentences where the sentences were a list of words and list of words
\end{enumerate}
