...
\begin{table}[]
	...
	\begin{tabular}{|p{2.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|}
		...
		\hline
		\hline
		NB + BoW (all words)  & 0.79  & 0.70  & 0.86  & 0.84  & 0.79   & \textbf{0.75}   & 0.82    \\
		\hline
		
		SVM + BoW (all words)   & 0.82  & 0.70 & 0.86 & 0.80 & 0.68  & \textbf{0.75} & \textbf{0.86}                                                                                                                                    \\
		\hline    
		
		NB + BoW (stopwords \newline removed) & 0.85 &  0.79 & \textbf{0.90}  &  0.84 &  \textbf{0.80}   &  0.74   &  0.80    \\
		\hline
		
		SVM + BoW (stopwords \newline removed)  &  0.78 &  0.80  & \textbf{0.90} &  \textbf{0.87} & 0.78  &  0.72   &  0.81 \\
		\hline   
		\hline                                                                                                                                                                                                             
				
		NB + \newline TF-IDF \newline (all words)   & 0.79 & 0.74 & 0.87 & 0.80 & 0.79  & 0.62  & 0.80  \\
		\hline
		
		SVM + \newline TF-IDF \newline (all words)   & 0.80 & 0.70 & 0.84 & \textbf{0.84} & \textbf{0.80}  & 0.68  & 0.82                                                                                                                                             \\
		\hline                                                                                                                                                                                                            
		
		NB + \newline TF-IDF \newline (stopwords \newline removed)  &  0.79 & 0.80  &  0.89 &  0.81 & 0.77   & 0.69   &  0.81  \\
		\hline
		
		SVM + \newline TF-IDF \newline (stopwords \newline removed)  &  \textbf{0.86} & \textbf{0.85} & 0.89  &  0.86  &  \textbf{0.80}  & \textbf{0.77}  & \textbf{0.82}  \\
		\hline                                                                        \hline                                                       
		
		NB + GloVe  & \textbf{0.82} & \textbf{0.78} & \textbf{0.89} & 0.82  & 0.78   & 0.68    & 0.83   \\
		\hline
