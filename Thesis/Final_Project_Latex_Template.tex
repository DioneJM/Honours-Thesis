...
\label{sec:BaselineTrainingTime}

\textit{This will also probably be focusing the features used rather than the model itself}

\subsection{Model speed}
\label{sec:BaselineModelSpeed}
\textit{Discuss the computational complexity of the baseline models - experiments might not be necessary for this}


\section{Deep Learning Results}
\label{sec:DeepLearningResults}
...
\subsection{Storage Requirements}
\label{sec:DLStorageRequirements}
...
\subsection{Training Time}
\label{sec:DLTrainingTime}

\begin{table}[H]
	\centering
	\begin{tabular}{|p{3cm}|p{2cm}|}
		\hline
		Language Model & Training Time (s)                                                                                                                                                                                                                                                                                                                                                    \\
		\hline                                                                                                                                              
...
\subsection{Model Speed}
\label{sec:DLModelSpeed}
\textit{Again talk about the computational complexity of the model's architecture}
