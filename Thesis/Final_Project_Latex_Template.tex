...
\begin{table}[]
	...
	\begin{tabular}{|p{2.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|}
		...
		\textbf{Model} & \textbf{Criteria 1    }                                                                       & \textbf{Criteria 2}    & \textbf{Criteria 3 }& \textbf{Criteria 4} & \textbf{Criteria 5} & \textbf{Criteria 6} & \textbf{Criteria 7         }                                                                                                                                                                                                                                                                                                                                                 \\
		\hline

		NB + BoW (all words)  & 0.79  & 0.70  & 0.86  & 0.84  & 0.79   & 0.75   & 0.82    \\
		\hline
		
		SVM + BoW (all words)   & 0.82  & 0.70 & 0.86 & 0.80 & 0.68  & 0.75 &  \textbf{0.86}                                                                                                                                    \\
		\hline
...
\begin{table}[]
	\resizebox{\textwidth}{!}{%
	\begin{tabular}{|p{2.5cm}|p{1.65cm}|p{1.65cm}|p{1.65cm}|p{1.6cm}|p{1.65cm}|p{1.65cm}|p{1.65cm}|p{1.65cm}|}
		\hline

		\textbf{Vocabulary Size Limit} & \textbf{Storage Size (MB) }& \textbf{Criteria 1    }                                                                       & \textbf{Criteria 2}    & \textbf{Criteria 3 }& \textbf{Criteria 4} & \textbf{Criteria 5} & \textbf{Criteria 6} & \textbf{Criteria 7         }                                                                                                                                                                                                                                                                                                                                                         \\
		\hline      
...
\begin{table}[]
	...
	\begin{tabular}{|p{3cm}|p{2cm}|}
		...
		\textbf{Language Model} & \textbf{Size (MB)   }                                                                                                                                                                                                                                                                                                                                                 \\
		\hline                                                                                                                                              
