...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|}
			...
			\multirowcell{2}{\textbf{Criteria 2:} \\ \textbf{Information based research}} & NB & 0.70 & 0.79 & 0.74 & 0.80 & 0.78 \\ 
...
The QRNN-based models performed poorer across all criteria compared to the other models (Table \ref{table:PerformanceResultsQRNN}) relative to the NB and SVM based models. The use of the fine-tuned LM with the QRNN classifier consistently reported an improved performance when compared to the use of the general language model. \newline
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{6cm}|p{2cm}|p{3cm}|p{3.3cm}|}
			...
			\multirowcell{2}{\textbf{Criteria 2:} \\ \textbf{Information based research}} 
			& QRNN & 0.36 & 0.39 \\ 
			&  & &\\ 
			\hline 
