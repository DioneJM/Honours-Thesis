...
The performance of all 91 models were evaluated using the credibility classification experiment. 
...
\begin{table}[H]
	...
	\begin{tabular}{|p{2.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{2.5cm}|}
		...
		NB + BoW (stopwords \newline removed) & 0.85 &  0.79 &  \textbf{0.90}  &  0.84 &   \textbf{0.80}   &  0.74   &  0.80 & 0.820    \\
		\hline
		...
		NB + \newline TF-IDF \newline (stopwords \newline removed)  &  0.79 & 0.80  &  0.89 &  0.81 & 0.77   & 0.69   &  0.81 & 0.794  \\
		\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{4.4cm}|p{5cm}|}
		...
		\textbf{SVM Model} & \textbf{Size (MB)}                                                                                                                                                                                                                                                                                                                                                    \\
		\hline                                                                                                                                              
		
		SVM + BoW  (all words)  & 7.91  \\
		\hline
		
		SVM + BoW \newline (stopwords removed)  & 7.87  \\
		\hline
	...
	\end{tabular}
	\caption{Average training time of SVM model variants.}
	\label{table:SVMStorageRequirements}
\end{table}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{3cm}|p{2cm}|}
		...
		\textbf{QRNN Model} & \textbf{Size (MB)   }                                                                                                                                                                                                                                                                                                                                                 \\
		\hline                                                                                                                                              
		
		QRNN + \newline General LM  & 516  \\
		\hline
		
		QRNN + \newline Fine-tuned LM  & 599  \\
		\hline
