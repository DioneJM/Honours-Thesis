...
For the purposes of training and evaluating the performance of the baseline and deep learning models for this novel classification task, a dataset consisting of \textbf{\textit{1 billion}} articles that have been manually and expertly labelled based on the criteria outlined in Table \ref{table:Criteria} has been produced. Due to the expert-level knowledge and skill set required to manually label the articles being out of the scope of this project and unfeasible given the time constraints of this project, the articles within of dataset were manually labelled by the same team that developed the credibility criteria as discussed in Section \ref{sec:CredibilityCriteria}.
