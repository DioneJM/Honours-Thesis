...
\begin{itemize}
	\item Evaluate the performance of deep learning based text classification algorithms in determining the credibility of information present within health related online articles.
...
\begin{itemize}
	\item \textit{Utilize attention mechanisms to understand how the previously evaluated models work?}
\end{itemize}

\subsection{Project Cost}
\label{sec:ProjectCost}
\textit{Expected cost of the project}
...
\textit{Talk about commonly used ML models for text classification e.g. SVM, Random Forest or Naive Bayes and justify which model(s) I will use as a baseline}
