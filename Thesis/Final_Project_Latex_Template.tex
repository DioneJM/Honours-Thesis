...
Count based approaches such as BoW, TF-IDF are a class of simple representation techniques that rely on the frequency of words to extract or represent the information in a format that can be utilised by machine learning models. The BoW model, the simplest of these count based approaches, represents a document as the number of occurrences of each word within the document. 

\subsubsection{Probabilistic Representations}
\label{sec:ProbRepresentations}
