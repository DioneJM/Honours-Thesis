...
\textit{\textbf{Talk about the fact that this method was only evaluated on common classification tasks using commonly used datasets whereas this project is interested in using this method on a novel classification task using a dataset made specifically for the task.}}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[totalheight=8cm]{images/article-score-distribution.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[totalheight=8cm]{images/label-distribution.png}
