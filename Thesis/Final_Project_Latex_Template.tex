...
\begin{table}[H]
	...
	\begin{tabular}{|p{1.7cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|}
		...
		\hline
		NB + BoW  & 0.79 \newline ($\pm$ 0.16) & 0.70 \newline ($\pm$ 0.12) & 0.86 \newline ($\pm$ 0.07) & 0.84 \newline ($\pm$ 0.13) & 0.79 \newline ($\pm$ 0.04)  & \textbf{0.75} \newline ($\pm$ 0.07)  & 0.82 \newline ($\pm$ 0.07)   \\
		\hline
		
		SVM + BoW  & 0.82 \newline ($\pm$ 0.7) & 0.70 \newline ($\pm$ 0.02) & 0.86 \newline ($\pm$ 0.03) & 0.80 \newline ($\pm$ 0.03) & 0.68 \newline ($\pm$ 0.07)  & \textbf{0.75} \newline ($\pm$ 0.07)  & \textbf{0.86} \newline ($\pm$ 0.05)                                                                                                                                             \\
		\hline                                                                                                                                                                                                                
				
		NB + TF-IDF  & 0.79 \newline ($\pm$ 0.06) & 0.74 \newline ($\pm$ 0.07) & 0.87 \newline ($\pm$ 0.07) & 0.80 \newline ($\pm$ 0.04) & 0.79 \newline ($\pm$ 0.04)  & 0.62 \newline ($\pm$ 0.04)  & 0.80 \newline ($\pm$ 0.04)  \\
		\hline
		
		SVM + TF-IDF  & 0.80 \newline ($\pm$ 0.03) & 0.70 \newline ($\pm$ 0.02) & 0.84 \newline ($\pm$ 0.01) & \textbf{0.84} \newline ($\pm$ 0.05) & \textbf{0.80} \newline ($\pm$ 0.02)  & 0.68 \newline ($\pm$ 0.02)  & 0.82 \newline ($\pm$ 0.03)                                                                                                                                             \\
		\hline                                                                                                                                              
		
		NB + GloVe  & \textbf{0.82} \newline ($\pm$ 0.00) & \textbf{0.78} \newline ($\pm$ 0.00) & \textbf{0.89} \newline ($\pm$ 0.00) & 0.82 \newline ($\pm$ 0.00) & 0.78 \newline ($\pm$ 0.00)  & 0.68 \newline ($\pm$ 0.00)   & 0.83 \newline ($\pm$ 0.01)  \\
		\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{1.7cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|}
		...
		Model & Criteria 1                                                                           & Criteria 2    & Criteria 3 & Criteria 4 & Criteria 5 & Criteria 6 & Criteria 7                                                                                                                                                                                                                                                                                                                                                          \\
		\hline
		NB + BoW  & 0.85 \newline ($\pm$ 0.06) &  0.79 \newline ($\pm$ 0.08)  & \textbf{0.90} \newline ($\pm$ 0.03)  &  0.84 \newline ($\pm$ 0.12)  &  \textbf{0.80} \newline ($\pm$ 0.07)   &  0.74 \newline ($\pm$ 0.09)   &  0.80 \newline ($\pm$ 0.07)    \\
		\hline
		
		SVM + BoW  &  0.78 \newline ($\pm$ 0.07)  &  0.80 \newline ($\pm$ 0.11)  & \textbf{0.90} \newline ($\pm$ 0.04)  &  \textbf{0.87} \newline ($\pm$ 0.08)  & 0.78 \newline ($\pm$ 0.08)   &  0.72 \newline ($\pm$ 0.08)   &  0.81 \newline ($\pm$ 0.06)  \\
		\hline                                                                                                                                                                                                                
				
		NB + TF-IDF  &  0.79 \newline ($\pm$ 0.01)  & 0.80 \newline ($\pm$ 0.02)  &  0.89 \newline ($\pm$ 0.00)  &  0.81 \newline ($\pm$ 0.02)  & 0.77 \newline ($\pm$ 0.01)   & 0.69 \newline ($\pm$ 0.02)   &  0.81 \newline ($\pm$ 0.02)   \\
		\hline
		
		SVM + TF-IDF  &  \textbf{0.86} \newline ($\pm$ 0.06)  & \textbf{0.85} \newline ($\pm$ 0.08)  & 0.89 \newline ($\pm$ 0.02)  &  0.86 \newline ($\pm$ 0.08)  &  \textbf{0.80} \newline ($\pm$ 0.08)   & \textbf{0.77} \newline ($\pm$ 0.08)   & \textbf{0.82} \newline ($\pm$ 0.07)  \\
		\hline                                                                                                                                                                                                                                                                                                                             
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{|p{1.7cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|p{1.6cm}|}
		...
		NB + GloVe  & \textbf{0.78} \newline ($\pm$ 0.01) & \textbf{0.79} \newline ($\pm$ 0.00) & \textbf{0.90} \newline ($\pm$ 0.01) & \textbf{0.81} \newline ($\pm$ 0.01) & \textbf{0.77} \newline ($\pm$ 0.01)  & \textbf{0.68} \newline ($\pm$ 0.00)   & \textbf{0.81} \newline ($\pm$ 0.00)  \\
		\hline
		
		SVM + GloVe  & 0.41 \newline ($\pm$ 0.27) & 0.40 \newline ($\pm$ 0.28) & \textbf{0.90} \newline ($\pm$ 0.01) & 0.60 \newline ($\pm$ 0.30) & \textbf{0.77} \newline ($\pm$ 0.01)  & 0.44 \newline ($\pm$ 0.17) & 0.60 \newline ($\pm$ 0.29)                                                                                                                                              \\
		\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|p{1.7cm}|p{1.65cm}|p{1.65cm}|p{1.6cm}|p{1.65cm}|p{1.65cm}|p{1.65cm}|p{1.65cm}|}
		...
		PT + FT Wiki  & \textbf{0.42} & \textbf{0.39} & \textbf{0.44} & \textbf{0.40} & \textbf{0.41} & \textbf{0.41}  & \textbf{0.43}   \\
		\hline
