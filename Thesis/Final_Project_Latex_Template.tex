...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|p{2.6cm}|}
			...
			\multirowcell{2}{\textbf{Criteria 1:} \\ \textbf{Use of evidence} } & NB & 0.79 & 0.85 & 0.79 & 0.79 & 0.82 \\ 
...
\begin{table}[H]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{6cm}|p{2cm}|p{3cm}|p{3.3cm}|}
			...
			\multirowcell{2}{\textbf{Criteria 1:} \\ \textbf{Use of evidence} } & QRNN & 0.38 & 0.42 \\ 
			&  & &\\ 
			\hline
			...
			\multirowcell{2}{\textbf{Criteria 6:} \\ \textbf{Simple Language}} & QRNN & 0.38 & 0.41 \\ 
			& & &\\
			\hline 
...
The reliability of the results reported in Chapter \ref{chap:Results} is firstly evaluated by examining the consistency of the general trends that emerged from the various experiments via the comparison of results from prior literature on text classification tasks (Section \ref{sec:ConsistencyOfResults}). \newline

Feasibility of the models are then determined by discussing the trade-offs associated between the outcome measures (as discussed in Section \ref{sec:Experiments}) and how the priority of each of these measures varies depending on the intended application (Section \ref{sec:ModelFeasibility}). \newline
