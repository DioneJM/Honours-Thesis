...
The criteria defined in Appendix A has been developed by health professionals which will be used 

\section{Study Data}
\label{sec:StudyData}

- \textit{Discuss the relationship of each category e.g. are they independent from each other? Is there any correlation? etc.}
\begin{figure}[!htb]
	\centering
	\includegraphics[totalheight=6cm]{images/label-distribution-fig-draft.jpg}
	\caption{Distribution of labels within the dataset \cite{RNNDiagram}}
...
\begin{table}[!htb]
	...
	\end{tabular}
	\caption{Average micro f1-Scores of baseline models}
