...
The criteria defined in Appendix A has been developed by health professionals which will be used to determine the credibility of health articles.
...
\begin{itemize}
	\item Evaluate the performance of the classifiers as outlined in Section \ref{sec:OutcomeMeasures}.
	\item Verify the correctness of the training data and ensure that the manually labelled training examples have been consistently labelled amongst the reviewers.
\end{itemize} 
...
\subsection{**REMEMBER TO RERUN EXPERIMENTS WHEN LABELLING IS COMPLETED**}
\begin{table}[!htb]
	\centering
	\begin{tabular}{|p{2cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|}
		...
		\hline
		NB + BoW  & X.X & X.X & X.X & X.X & X.X  & X.X  & X.X  \\
		\hline
		
		SVM + BoW  & X.X & X.X & X.X & X.X & X.X  & X.X  & X.X                                                                                                                                              \\
		\hline
		
		RF + BoW  & X.X & X.X  & X.X & X.X & X.X & X.X & X.X                                                                                                                                                                                                               
		\\
		\hline 
				
		NB + TF-IDF  & X.X & X.X & X.X & X.X & X.X  & X.X  & X.X  \\
		\hline
		
		SVM + TF-IDF  & X.X & X.X & X.X & X.X & X.X  & X.X  & X.X                                                                                                                                              \\
		\hline
		
		RF + TF-IDF  & X.X & X.X  & X.X & X.X & X.X & X.X & X.X                                                                                                                                                                                                               
		\\
		\hline 
		
		NB + Word2Vec  & X.X & X.X & X.X & X.X & X.X  & X.X  & X.X  \\
		\hline
		
		SVM + Word2Vec  & X.X & X.X & X.X & X.X & X.X  & X.X  & X.X                                                                                                                                              \\
		\hline
		
		RF + Word2Vec  & X.X & X.X  & X.X & X.X & X.X & X.X & X.X                                                                                                                                                                                                               
		\\
		\hline                                                                    
	\end{tabular}
	\caption{F1-Scores of baseline models}
...
\appendix
\chapter{Credibility Criteria}
\section{Overview}
The following table details the criteria that will be used to determine the credibility of articles.
\section{Credibility Criteria Table}
\begin{table}[!htb]
	\centering
...
\label{table:CredibilityCritieria}
\end{table}
