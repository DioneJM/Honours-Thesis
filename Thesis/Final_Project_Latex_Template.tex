...
From the reported results, major trends that were identified are listed as follows:
...
\begin{enumerate}
	...
	\item Inversely, TF-IDF scores were more effective when paired with SVM classifiers than with NB classifiers.
