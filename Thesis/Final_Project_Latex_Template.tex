...
Despite CNNs being initially developed for object recognition tasks \cite{LeCun1999}, over the past few years, CNNs have seen extensive applications in text classification tasks such as sentence classification and sentiment analysis producing competitive results when compared to RNNs and its variants \cite{Collobert2011} \cite{Kim} \cite{Nogueira}. 

A CNN is composed of 
