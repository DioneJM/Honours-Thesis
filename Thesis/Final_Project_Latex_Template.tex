...
The criteria defined in Table \ref{table:Criteria} has been developed by health professionals which will be used to define the structure and content that a health-related article must have to be considered as a credible source of information. 
...
\begin{figure}[!htb]
	...
	\caption{Distribution of labels amongst the labelled samples}
...
\begin{figure}[!htb]
	...
	\caption{Distribution of article scores amongst the labelled samples}
